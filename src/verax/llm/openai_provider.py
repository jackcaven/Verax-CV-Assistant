...
class OpenAIProvider:
    """OpenAI LLM provider using gpt-4."""
    ...
    def extract_structured_cv(self, raw_text: str, original_filename: str = "") -> StructuredCV:
        """Extract CV structure using OpenAI gpt-4.
    ...
    def map_sections(
        ...
        """Remap CV sections to template structure using OpenAI.
